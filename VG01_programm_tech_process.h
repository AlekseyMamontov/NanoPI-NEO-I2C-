...
struct Tech_transition Plate_200x140_init ={
 ...
 .device_on_off={
	.pin={PNEVMOCYLINDR, VACUUM_VALVE, RELE_LIMITER,PNEVMOCYLINDR_2},
 ...
 */
 ...
 /*
  * выдержать паузу - время необходимое для выемки штамповки  600 мс
  * а потом дунуть)
  * 
  * 
  */
 ...
 .transition_type = PAUSE_AND_DEVICE_TRANSITION,
 .transition_information ="pause 700 mc + вакуум  off\n",
 ...
 .next_transition = &Plate_200x140_n6,
 };
 /*
 ...
 struct Tech_transition Plate_200x140_n6 ={
	
 .transition_type = PAUSE_AND_DEVICE_TRANSITION,
 .transition_information ="pause 700 mc + вакуум  off\n",
 	 	
 
 .transition_delay= {0,150000000},
 		
 .device_on_off={
	.pin   ={VACUUM_VALVE,RELE_LIMITER,RELE_LIMITER2},
	.value ={LOW,HIGH,LOW},
	.N_pin = 3,
	},
