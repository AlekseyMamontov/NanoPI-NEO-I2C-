...
void Tech_process_start (struct TFT_menu *menu){	

static uint8_t number_operation;

struct Tech_process *process = (struct Tech_process *) menu->selected_line->data;	

//отобразить меню
tft_menu_submenu (menu);	

number_operation = 0; //исправить
	
Tech_set_command(process,START_OPERATION,NULL);	
