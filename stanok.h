 ...
 * Первый переход, 
 * выдержать паузу 1 с
 * включить пневмоциллиндр опустить пуансон и поднять присоски на захват заготовки.
 */
...
struct Tech_transition Plate_200x140_n1 ={
 ...
 .transition_information = "pause 1 sec + Pneumocylinder ON \n",	
  	
 .transition_delay= {1,0}, // sec,nsec		
 ...
 */
 ...
 .transition_type = PAUSE_AND_DEVICE_TRANSITION,
 .transition_information = "Pause 1 sec 500mc  + Vacuum_valve  ON \n ",	 	
 ...
 */
 ...
 .transition_type = PAUSE_AND_DEVICE_TRANSITION,
 .transition_information ="pause - > off pnevmocylindry \n",
 
 .transition_delay= {0,250000000},	
  ...
  * Четвертый переход
  * 
  * выдержать паузу - время необходимое для выемки штамповки  200 мс
 ...
 .transition_type = PAUSE_AND_DEVICE_TRANSITION,
 .transition_information ="pause 200 mc + вакуум  off\n",
 	 	
 
 .transition_delay= {0,200000000},
