...
struct MCP23017_PIN mcp_gpio[] ={
	...
	{&chip1,7,pin_IN,pin_no_pullUP,pin_HIGH,pin_LOW}, //pin7 - оптопара вход  транзистор											
 	{&chip1,14,pin_IN,pin_no_pullUP,pin_HIGH,pin_LOW}, //pin8 - оптопара на замыкание
...
struct Indikator Indikators_devices={
 ...
 .info_block = {   
	...
	.pin_indikator = {	&mcp_gpio[4], // пины устройств которые мы контролируем на изменения
						&mcp_gpio[5],
						&mcp_gpio[3],
						&mcp_gpio[2]}, 	    
...
struct Indikator Indikators_sensors={
	 ...
	 .new_change_txt = {0}, 
		...
		.pin_indikator = {&mcp_gpio[8], // пины устройств которые мы контролируем
						  &mcp_gpio[7],
						  &mcp_gpio[9],
						}, 
