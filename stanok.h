...
//pin8 - оптопара PC817 вход транзистор (база).
...
//pin9 - - оптопара PC817 вход на замыкание +5v.
...
struct Tech_transition Plate_160x200_n4 ={
 ...
 .transition_delay={
   .tv_sec = 4,  // при использовани датчмка задержка не нужна
   .tv_nsec = 0,	 
  },	 
 .dependency = NULL,
 .N_dependency = 0,	 
...
// Операция штамповки
uint16_t Temperature_mode_1_on[]  ={200,202};
uint16_t Temperature_mode_1_off[] = {205,206};
