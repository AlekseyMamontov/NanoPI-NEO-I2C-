...
uint16_t Temperature_mode_1_on[]  ={200,200};
uint16_t Temperature_mode_1_off[] = {205,205};
 ...
 */
 ...
 .transition_type = PAUSE_AND_DEVICE_TRANSITION,
 .transition_information ="pause 500mc + Pnemvocylinder OFF \n",	 	
 ...
 .transition_type = PAUSE_AND_DEVICE_TRANSITION,
 .transition_information ="pause 200mc + limiter on \n",	 	
 ...
 .transition_type = PAUSE_AND_DEVICE_TRANSITION,
 .transition_information ="pause 200mc + limiter off \n",	 	
 ...
 .move_to_next_transition = TECH_PROCESS_DEVICE_ON_OFF | TECH_PROCESS_PAUSE,
 .next_transition = &Plate_160x200_n6,
...
struct Tech_transition Plate_160x200_n6 ={
	
 .transition_type = PAUSE_AND_DEVICE_TRANSITION,
 .transition_information = "pause + Vacuum_valve and rele_limiter OFF \n ",	 	
 .check_sensors = 0,		
 ...
 .transition_delay={
   .tv_sec = 0,  // при использовани датчмка задержка не нужна
   .tv_nsec = 200000000 
  },	
 .dependency = NULL,
 .N_dependency = 0,	 
