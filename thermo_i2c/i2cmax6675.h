...
struct nGPIO_cycle_Data max6675={
	
	.cs = thermosensor->pin_cs,
	.clk = thermosensor->pin_clk,
	.pin_raw = buf,
	.num_pin_raw = 16,
	.pin_miso = thermosensor->pin_miso,
	.num_pin_miso = thermosensor->N_thermal_sensors,
	.status = 1,
};

gpio_set_command (&Stanok_gpio,GET_RAW_MAX6675,&max6675);

while(max6675.status){};
